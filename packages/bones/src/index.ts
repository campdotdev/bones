import { BonesBoundary } from "./element/boundary.ts";

export { BonesBoundary, DEFAULT_DELAY, DEFAULT_MIN_DURATION } from "./element/boundary.ts";
...
//
// `import "@camp.dev/bones"` is the whole setup. The guard keeps the
...
if (typeof customElements !== "undefined") {
  if (customElements.get("bones-boundary")) {
    console.warn("bones-boundary is already defined; @camp.dev/bones did not register");
  } else {
