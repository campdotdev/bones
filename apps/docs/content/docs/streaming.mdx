...
<head>
  ...
  <script type="module">import "https://unpkg.com/@camp.dev/bones/dist/element/index.mjs";</script>
</head>
<body>
  <h1>Dashboard</h1>
...
- Ids must match `[A-Za-z0-9_-]+` and be unique in the document. An invalid id throws before the stream starts.
