...
Turbo sets `aria-busy` on frames and forms by itself; React, Vue, and Svelte bind it in the template; htmx and Livewire wire it in a line or two. The docs' [Integrations](apps/docs/content/docs/integrations.mdx) page has the per-stack recipes and a bookmarklet that skeletonizes any page.
